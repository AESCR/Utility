...
namespace Common.Utility.JwtBearer
{
    ...
    public static class RSA
    {
        ...
        public static bool CheckSign(string content, string publicKey, string sign, Encoding encoding,
        ...
        public static RSAParameters DecodePkcsPrivateKey(string privateKey)
        {
            ...
            try
            {
                ...
                //解析Pkcs证书
                var type = GetPrivateKeyType(privateKeyData.Length);
        ...
        public static RSAParameters DecodePkcsPublicKey(string publicKey)
        {
            ...
            using (var binr = new BinaryReader(new MemoryStream(publicKeyData)))
            {
                byte bt = 0;
                ushort twobytes = 0;
