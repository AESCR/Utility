...
namespace Common.Utility.Random.ChineseName
{
    public class RandomName
    {
        ...
        /// 姓氏列表
        /// </summary>
        private string[] arrLastName = null;

        /// <summary>
        /// 生成的名字列表
        /// </summary>
        private List<string> listCnNames = new List<string>();

        /// <summary>
        /// 名字字符的个数
        /// </summary>
        private System.Random rdCharCount = new System.Random();

        /// <summary>
        /// 名字的字符对应的十进制
        /// </summary>
        private System.Random rdFirstName = new System.Random();

        /// <summary>
        /// 姓氏在姓氏列表中的索引
        /// </summary>
        private System.Random rdLastNameIndex = new System.Random();

        private string strLastName = "赵 钱 孙 李    周 吴 郑 王    冯    陈    褚    卫    蒋    沈    韩    杨    朱    秦    尤    许 "
